...
<head>
    ...
    <title>LOGIN | RADJA WEDDING</title>
    <!-- Custom CSS -->
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="{{ asset('Assets/assets/images/big/icon.png') }}" alt="Logo">
                        </div>
                        <h2 class="mt-3 text-center">Sign In</h2>
                        <p class="text-center">Masukkan Username dan Password untuk mengakses Layanan Kami.</p>
                        <form class="mt-4">
                            <div class="row">
                                <div class="col-lg-12">
